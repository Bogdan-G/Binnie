...
public class ModuleItems implements IInitializable
{
	...
	public void postInit() {
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(ExtraTreeItems.GrainBarley.get(3), new Object[] { false, " s ", "s  ", " s ", 's', ExtraTreeItems.GrainWheat.get(1) }));
		GameRegistry.addRecipe(new ShapedOreRecipe(ExtraTreeItems.GrainCorn.get(3), new Object[] { false, " s ", "  s", " s ", 's', ExtraTreeItems.GrainWheat.get(1) }));
